...
(*platform-bits* _symbol_...)

_bits_ is a positive exact integer giving the address width of the
...
* Get the full feature list: `(assoc 'features alist)`
* Does it support R7RS? `(not (not (member 'r7rs (assoc 'languages alist))))`
